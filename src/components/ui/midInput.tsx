    ...
    return (
      <div className="relative">
        ...
        <input
          type={type}
          className={cn(
            'flex h-10  rounded-lg border border-[#434345] bg-transparent px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground  disabled:cursor-not-allowed disabled:opacity-50 lg:w-[280px] lg:h-[57px] font-semibold:normal lg:text-[20px] min-[320px]:w-[230px] x:w-[280px] x:h-14 pro:w-[295px] fold:w-[340px]',
